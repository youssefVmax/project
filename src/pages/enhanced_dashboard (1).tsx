...
export const EnhancedDashboard: React.FC = () => {
  ...
  // Weekly and Monthly aggregations for deeper analysis
  // Monthly trend aggregation for insights and charts
      ...
      <>
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            ...
            <span className="text-sm text-slate-500 dark:text-slate-400">(Distinct values only)</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
          {[
            ...
            { 
              ...
              color: 'green', 
              trend: '+8%', 
              deals: `${Math.round((totalCommission/totalAmount)*100)}% rate`,
