...
const EnhancedCustomerPrediction: React.FC = () => {
  ...
  // Define lastPrediction for use in JSX
  const lastPrediction = Array.isArray(predictions) && predictions.length > 0 ? predictions[predictions.length - 1] : null;
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      {/* Header */}
      <motion.div
      ...
      >
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Advanced Prediction Settings</h3>
          {isLoading && (
            <motion.div
              animate={{ rotate: 360 }}
      ...
      <div className="flex flex-col gap-8 mb-8 w-full max-w-6xl mx-auto">
        {/* Top Programs Predictions (full width) */}
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1.1 }}
          className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 flex flex-col"
        >
          <div className="flex items-center space-x-3 mb-4">
            <Target className="w-6 h-6 text-green-600" />
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Top Programs Predictions</h3>
          </div>
        ...
        {/* Top Sales Agents Predictions (full width) */}
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1.1 }}
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Top Sales Agents Predictions</h3>
          </div>
          <div className="space-y-4">
        ...
        {/* Advanced Analytics Summary (full width) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
